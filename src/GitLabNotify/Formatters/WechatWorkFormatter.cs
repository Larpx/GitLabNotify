...
/// 本实现使用 markdown 类型，以便在消息中包含链接和格式。
/// </remarks>
public class WechatWorkFormatter : IEventFormatter
{
    /// <inheritdoc/>
    public string TargetType => Models.TargetType.WechatWork;
